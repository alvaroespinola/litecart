    ...
    public function save() {
      ...
      database::query(
        ...
        set
		  ...
		  latitude = '". database::input($this->data['latitude']) ."',
		  longitude = '". database::input($this->data['longitude']) ."',
		  ...
		  shipping_latitude = '". database::input($this->data['shipping_address']['latitude']) ."',
		  shipping_longitude = '". database::input($this->data['shipping_address']['longitude']) ."',
